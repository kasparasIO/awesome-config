...
local utils = require("widgets.topbar.audio.utils")
...
local widget_types = {
	icon_and_text = require("widgets.topbar.audio.widgets.icon-and-text-widget"),
	icon = require("widgets.topbar.audio.widgets.icon-widget"),
	arc = require("widgets.topbar.audio.widgets.arc-widget"),
	horizontal_bar = require("widgets.topbar.audio.widgets.horizontal-bar-widget"),
	vertical_bar = require("widgets.topbar.audio.widgets.vertical-bar-widget"),
}
local volume = {}
